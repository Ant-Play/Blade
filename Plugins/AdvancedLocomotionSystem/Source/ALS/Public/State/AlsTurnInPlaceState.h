...
struct ALS_API FAlsTurnInPlaceState
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "ALS", Meta = (ForceUnits = "s"))
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "ALS", Meta = (ClampMin = 0, ForceUnits = "s"))
	float PlayRate{ 1.0f };
