...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings")
	uint8 bScalePlayRateByAnimationTurnAngle : 1 { true };
...
struct ALS_API FAlsGeneralTurnInPlaceSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS", DisplayName = "Turn 180 Angle Threshold", Meta = (ClampMin = 0, ClampMax = 180, ForceUnits = "deg"))
