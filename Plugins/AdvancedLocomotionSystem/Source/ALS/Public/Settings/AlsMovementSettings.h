...
////
////public:
////	FGameplayTag t = AlsLog::FMessageLog::Test;
////
////	/*UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings", Meta = (ForceInlineRow))
...
//class ALS_API UAlsMovemeSettings : public UDataAsset
//{
//	GENERATED_BODY()
//
//public:
