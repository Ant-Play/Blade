...
struct ALS_API FAlsMantlingParameters
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS")
	FRotator TargetReltativeRotation{ ForceInit };
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "Settings", Meta = (EditCondition = "!bAutoCalculateStartTime", ClampMin = 0))
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "ALS", AdvancedDisplay, Meta = (ClampMin = 0, ClampMax = 1))
	...
	FCollisionResponseContainer MantlingTraceResponse{ ECR_Ignore };
