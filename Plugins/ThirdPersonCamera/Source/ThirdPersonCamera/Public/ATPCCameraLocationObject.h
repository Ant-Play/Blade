...
struct THIRDPERSONCAMERA_API FATPCRuntimeCameraOffsetRotationSettings
{
public:
	float LastChangeCameraRotationTime = 0.0f;
	bool bPendingRotationOffset = false;
};

struct THIRDPERSONCAMERA_API FATPCRuntimeCameraToActorRotationSettings
{
public:
...
class THIRDPERSONCAMERA_API UATPCCameraLocationObject : public UATPCCameraBaseObject, public IVisualLoggerDebugSnapshotInterface
{
	GENERATED_BODY()
...
public:
	...
	virtual void UpdateDesireArmLocation(bool bDoTrace, bool bDoLocationLag, bool bDoRotationLag, float DeltaTime);
...
protected:
	...
	float GetCameraDistanceModifier() const;
