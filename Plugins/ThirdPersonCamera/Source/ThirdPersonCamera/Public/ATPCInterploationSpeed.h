...
#include "ATPCInterploationSpeed.generated.h"
...
public:
	...
	bool bUseInterpSpeedToInterpolation = false;

	/** See @bUseInterpSpeedToInterpolation */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings", meta = (EditCondition = "bUseInterpSpeedToInterpolation", ClampMin = "0.0", UIMin = "0.0", EditCondition = "bUseInterpSpeedToInterpolation"))
