...
class THIRDPERSONCAMERA_API UATPCCameraComponent : public USceneComponent
{
	GENERATED_BODY()
...
public:	
	...
	virtual void ValidateComponent(bool bWithInterpolation);
	...
	void ZoomOut();
	UFUNCTION(BlueprintCallable, Category = "ATPC|Zoom")
	void SetCameraDistance(float NewDistance, bool bInterpolation);
	//~ End Zoom Func
...
private:
	UPROPERTY()
	mutable UATPCCameraModeDataAsset* EmptyCameraMode;
