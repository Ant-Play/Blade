...
struct THIRDPERSONCAMERA_API FATPCCameraLocationLagSettings
{
	GENERATED_BODY()
...
public:
	...
	*/
	...
	float CameraLagMaxDistance = 30.0f;
	...
	float CameraLagMaxTimeStep = 1 / 60.0f;

};

USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCCameraRotationLagSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCLocationSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCRotationOffsetSettings
{
	GENERATED_BODY()

public:
	FATPCRotationOffsetSettings() = default;
	FATPCRotationOffsetSettings(float InStartOffsetDelay, const FATPCInterploationSpeed& InRotationInterpolation, float InPitchOffset)
		: StartOffsetDelay(InStartOffsetDelay), RotationInterpolation(InRotationInterpolation), PitchOffset(InPitchOffset) {}
...
*/
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCRoofCollisionCheckSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCViewRotationToActorRotationSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCRotationSettings
{
	GENERATED_BODY()
...
public:
	...
	*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Settings")
	FATPCInterploationSpeed ViewInterpolation = 50.0f;
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCFOVSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCFadeSettings
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCFollowTerrainSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCCameraShakesSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCLockOnTargetSettings
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCCameraMode
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct THIRDPERSONCAMERA_API FATPCCameraDebugRules
{
	GENERATED_BODY()
