...
class THIRDPERSONCAMERA_API UATPCCameraFadingObject : public UATPCCameraBaseObject
{
	GENERATED_BODY()
...
public:
	...
	UFUNCTION(BlueprintCallable, Category = "ATPC")
	void AddManualFadeActor(AActor* Actor, bool bWithCustomeTime = false, float CustomFadeOutTime = 0.f);
	UFUNCTION(BlueprintCallable, Category = "ATPC")
...
protected:
	...
	TSet<TWeakObjectPtr<AActor>> ManualFadeingActors;
};
